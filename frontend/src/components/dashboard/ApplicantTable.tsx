          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-50/50 border-b border-gray-50">
                <th className="px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wider font-dm-sans">Candidate Name</th>
                ...
                <th className="px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wider font-dm-sans text-center">Date Applied</th>
              ...
              {applicants.map((applicant) => (
                <tr key={applicant.id} className="border-b border-gray-50 last:border-0 group transition-all">
                  <td className="px-6 py-5">
                    <Typography variant="body" className="text-sm font-semibold text-gray-900 group-hover:text-primary transition-colors">{applicant.name}</Typography>
                  </td>
                  <td className="px-6 py-5 text-center">
                    <div className={cn(
                      "inline-flex items-center justify-center p-1.5 h-8 w-12 rounded-full text-xs font-semibold transition-all",
